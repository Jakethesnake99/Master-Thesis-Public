...
glabs=c(expression(hat(beta)[c]),expression(hat(beta)[lambda  * lambda]),expression(hat(w)),expression(hat(beta)),expression(hat(beta)[lambda*eta]),expression(hat(beta)[lambda]))
...
# Iterate through columns 1 to 6 and calculate differences
for (i in 1:6) {
